...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_iema8_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_iema8_dd.inc';
}

$config_directories[CONFIG_SYNC_DIRECTORY] = '../sync';
$config_directories['development'] = './sites/default/config/develop';
